...
const BottomLoginSheet = () => {
  /*
  The useSafeAreaInsets hook returns an object with the padding needed for each side of the screen to avoid intrusions of mobile screens (e.g. notches and corners).
  */
